 ...
 **********************************************************************************************************************/
uint32_t SF_CONSOLE_Open(sf_console_ctrl_t      * const p_ctrl,
...
uint32_t SF_CONSOLE_Read(sf_console_ctrl_t * const p_ctrl,
                          uint8_t           * const p_dest,
                          uint32_t            const bytes,
                          uint32_t            const timeout);
uint32_t SF_CONSOLE_Write(sf_console_ctrl_t * const p_ctrl,
